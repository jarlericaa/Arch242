    ...
    test_cases = [
        ...
        # Test 3: Memory instructions
        {
            ...
            'code': '''
                ...
                rcrd 0xAB
            ''',
            'expected_bin': ['00000100', '00000101', '01010101', '00000100', '01101011', '00001010'],
            'expected_hex': ['04', '05', '55', '04', '6b', '0a']
        },
        ...
        # Test 8: Complex program with calls
        {
            ...
            'code': '''
                ...
                subroutine:
                    ...
                    nop
                    ''',
            'expected_bin': ['01110101', '11110000', '00000110', '00110010', '11100000', '00001001', '00110001', '00110001', '00101110', '00111110'],
            'expected_hex': ['75', 'f0', '06', '32', 'e0', '09', '31', '31', '2e', '3e']
        },
